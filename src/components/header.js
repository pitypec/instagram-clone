...
export default function Header(){
    ...
    console.log(user)
    return (
        <header className='h-16 bg-white boder-b border-gray-primary mb-8' >
                         ...
                         {user ? (
                            ...
                            <>
                             <Link to={ROUTES.LOGIN}>
                               <button className='bg-blue-medium font-bold text-sm rounded text-white w-20 h-8'>Log In</button>
                             </Link>
                             <Link to={ROUTES.SIGN_UP}>
                               <button className='rounded text-blue-medium w-20 h-8 font-bold text-sm'>Sign Up</button>
                             </Link>
                            </>
                         )}
                    </div>
